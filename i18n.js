...
const EN = {
  meta: {
    ...
    description: 'Santino Basaldella. Argentine SUP Race athlete, double South American champion at ODESUR 2026, qualified for PASA Lima 2027, Pan American medalist and five-time Argentine champion. Discover his journey and be part of what comes next.'
  },
  ...
  'latest.eyebrow': '01 / LATEST RESULTS',
  ...
  'latest.qualification': '<span>QUALIFIED</span><h3>PASA <strong>LIMA 2027</strong></h3><p>A new international goal. The next chapter already has a destination.</p>',
  'latest.raceCaption': 'ODESUR 2026 · RACING',
  'results.caption': 'ARGENTINA ON THE PODIUM.',
  'results.eyebrow': '02 / THE JOURNEY',
