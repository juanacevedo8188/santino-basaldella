...
const EN = {
  ...
  'coach.text': 'Every podium starts long before the start line: on the water, session after session, alongside Guivi Basaldella, his uncle and coach. A family team bringing together fitness, technique and race strategy to compete at the highest level.',
  'coach.tags': '<span>TRAINING</span><span>TECHNIQUE</span><span>STRATEGY</span>',
  'coach.caption': 'SANTINO WITH GUIVI BASALDELLA, HIS UNCLE AND COACH.',
  ...
  'alt.coach': 'Santino with his uncle and coach, Guivi Basaldella, standing with their boards and paddles by the water',
